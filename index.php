...
<div class="home-main">
    <section class="home-hero rounded-4 p-4 p-lg-5">
            ...
            <div class="col-lg-6">
                <div class="home-hero__content">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a class="btn btn-bec-primary" href="<?php echo ROOT_URL . '/actualites.php'; ?>">Découvrir les actualités</a>
                        <a class="btn btn-bec-outline" href="<?php echo ROOT_URL . '/contact.php'; ?>">Nous contacter</a>
                    </div>
                    <div class="row g-3 mt-4 home-hero__stats">
    ...
    <section class="home-section">
        ...
        <div class="row g-4 mt-4">
            <div class="col-md-6 col-lg-4">
                <article class="info-card reveal h-100">
    ...
    <section class="home-section">
        ...
        <?php if (!empty($articles)): ?>
            <div class="row g-4 mt-4">
                <?php foreach ($articles as $article): ?>
                    ...
                    ?>
                    <div class="col-md-6 col-lg-4">
                        <article class="news-card reveal h-100">
        ...
        <?php else: ?>
            <p class="reveal mt-3">Aucun article disponible pour le moment.</p>
        <?php endif; ?>
    </section>
    ...
    <section class="home-cta reveal">
        <div class="row align-items-center g-4">
            <div class="col-lg-7">
                <span class="eyebrow text-white-50">Rejoignez-nous</span>
            ...
            <div class="col-lg-5">
                <div class="d-flex flex-wrap gap-3 justify-content-lg-end">
                    <a class="btn btn-light" href="<?php echo ROOT_URL . '/contact.php'; ?>">Écrire à l’équipe</a>
                    <a class="btn btn-bec-primary" href="<?php echo ROOT_URL . '/compte.php'; ?>">Créer un compte</a>
                </div>
            </div>
        </div>
    </section>
