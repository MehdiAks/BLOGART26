...
<body>
    <div class="image-fixe">
        <img src="src/images/background/background-article.jpg" alt="Image de fond">
    </div>
            ...
            <div class="section-left">
                <div class="contenu">
                    <article>
                        ...
                        <img class="image2" src="<?php echo ROOT_URL . '/src/uploads/' . ($article['urlPhotArt']); ?>"
                            alt="Image article">
                        <p class="petit">
                            © Groupe 01 Blog’Art MMI Bordeaux Montaigne
                        </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="article.php?numArt=<?php echo $numArt; ?>" method="post">
                                <div class="champ">
                                    <textarea id="libCom" name="libCom" class="form-control" type="text"
                                        required></textarea>
                                </div>
                    ...
                    foreach ($randomArticles as $randomArticle): ?>
                        <div class="random-article">
                            <img class="imagedroite"
                                src="<?php echo ROOT_URL . '/src/uploads/' . ($randomArticle['urlPhotArt']); ?>"
                                alt="Image article">
                ...
                <div class="container likes-section">
                    ...
                    <div class="vote-buttons">
                        ...
                        <form action="article.php?numArt=<?php echo $numArt; ?>" method="post">
                            ...
                            <button type="submit"
                                class="btn-vote <?php echo $userVote === 0 ? 'active-dislike' : ''; ?>">
