<?php
// Commentaire: Fichier PHP pour actualites.
...
<body>
    <div>
        ...
        <div class="image-fixe">
            <img src="src/images/background/background-actualite.jpg" alt="Image de fond">
        </div>

        <div>
            <h1 class="article1titre">
                <h1 class="titlehead">Nos Actualités</h1>
            </h1>

        </div>
        <h2 class="carre">
            <p class="accroche">Restez à l’affût de toute l’actualité sportive à Bordeaux: résultats, interviews et
                événements!</p>
        </h2>
                        ...
                        <div class="art">
                            <div class="random-article">
                                <img class="imagedroite"
                                    src="<?php echo ROOT_URL . '/src/uploads/' . htmlspecialchars($randomArticle['urlPhotArt']); ?>"
                                    alt="Image article">
                                <h2 class="titredroite">
                                    <?php echo htmlspecialchars($randomArticle['libTitrArt']); ?>
                                </h2>
                                <p class="txtdroite">
                                    <?php echo substr($randomArticle['libChapoArt'], 0, 100) . (strlen($randomArticle['libChapoArt']) > 100 ? '...' : ''); ?>
                                    </td>
                                </p>
                                <a href="article.php?numArt=<?php echo $randomArticle['numArt']; ?>" class="clickable-text">Lire
                                    l'article →</a>
                            </div>
                        </div>
                    <?php endforeach;
