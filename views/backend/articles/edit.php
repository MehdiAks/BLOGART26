            ...
            <form action="<?php echo ROOT_URL . '/api/articles/update.php' ?>" method="post"
                ...
                <div class="form-group">
                    ...
                    <input id="libAccrochArt" name="libAccrochArt" class="form-control" type="text"
                        value="<?php echo $article['libAccrochArt']; ?>" maxlength="1000" required />
                </div>

                <div class="form-group">
                    <label for="parag1Art">Paragraphe 1</label>
                    <textarea id="parag1Art" name="parag1Art" class="form-control" maxlength="2000"
                ...
                <div class="form-group">
                    ...
                    <input id="libSsTitr1Art" name="libSsTitr1Art" class="form-control" type="text"
                        value="<?php echo $article['libSsTitr1Art']; ?>" maxlength="1000" required />
                </div>

                <div class="form-group">
                    <label for="parag2Art">Paragraphe 2</label>
                    <textarea id="parag2Art" name="parag2Art" class="form-control" maxlength="2000"
                ...
                <div class="form-group">
                    ...
                    <input id="libSsTitr2Art" name="libSsTitr2Art" class="form-control" type="text"
                        value="<?php echo $article['libSsTitr2Art']; ?>" maxlength="1000" required />
                </div>

                <div class="form-group">
                    <label for="parag3Art">Paragraphe 3</label>
                    <textarea id="parag3Art" name="parag3Art" class="form-control" maxlength="2000"
                        required><?php echo $article['parag3Art']; ?></textarea>
                </div>

                <div class="form-group">
                    <label for="libConclArt">Conclusion</label>
                    <textarea id="libConclArt" name="libConclArt" class="form-control" maxlength="800"
                ...
                <div class="form-group">
                    ...
                    <select id="numThem" name="numThem" class="form-control" required>
                        ...
                        <?php foreach ($thematiques as $thematique) { ?>
                            <option value="<?= $thematique['numThem'] ?>" <?php echo $thematique['numThem'] == $article['numThem'] ? 'selected' : ''; ?>>
                                <?= $thematique['libThem'] ?></option>
                        <?php } ?>
                    </select>
                </div>
